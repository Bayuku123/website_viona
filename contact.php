                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Jl. Durian, Kecamatan Datuk Bandar, Tanjung Balai 120A</span> 
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-secondary">+628120192102(Pdt. Hossana Pepayosa Bangun)</span>
										<span class="text-secondary">+628129128192121(Pt. Theresia Ginting)</span>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="text-secondary">gbkptanjungbalai@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
